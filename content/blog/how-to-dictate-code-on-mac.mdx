...
Add project-specific terms to your [personal dictionary](/features/personal-dictionary). For the NVIDIA engine, dictionary terms also enable CTC vocabulary boosting — biasing the decoder at the acoustic level for better recognition.
