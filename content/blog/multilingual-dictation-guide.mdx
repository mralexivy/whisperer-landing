...
| **NVIDIA** | 25 | Fast inference for top languages |
| **Apple Speech** | System languages | Native macOS integration |

If you need a less common language, Whisper is the only backend with full coverage. For top-25 languages, NVIDIA offers the fastest inference.
