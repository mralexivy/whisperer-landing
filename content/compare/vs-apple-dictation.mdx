...
Apple Dictation uses a fixed system model. Whisperer lets you choose between [Whisper (Metal GPU), NVIDIA (Neural Engine), and Apple Speech](/features/offline-transcription) — trading speed for accuracy based on your needs.
